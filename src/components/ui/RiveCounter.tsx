...
/* The overlay must be measurement-neutral: no rAF loop, no looping
   animation, no backdrop blur. A rAF-based FPS counter forces the WebView
   to composite a frame every vsync, so it manufactures the exact idle
   CPU/GPU load it's used to diagnose. */
