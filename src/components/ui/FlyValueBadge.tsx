...
/**
 * How many flies this task holds, riding on the corner of its fly. When the
 * task is a checklist the flies arrive a few at a time, so it counts them in
...
export function FlyValueBadge({
  ...
  value: number;
  /** Flies banked so far. Omit for tasks that pay in one go. */
  caught?: number;
  size?: 'sm' | 'md';
}) {
