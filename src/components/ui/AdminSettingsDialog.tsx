...
export function AdminSettingsDialog({
  ...
  const handleResetMissedReview = async () => {
    ...
    try {
      const res = await fetch('/api/admin/reset-missed-review', {
        method: 'POST',
      });
      ...
      if (res.ok) {
        ...
        alert('Failed to reset missed review popup');
      }
    } catch {
      alert('Error resetting missed review popup');
    } finally {
      setLoading(null);
    }
  };
            ...
            >
              ...
              <div className="p-6 space-y-4 overflow-y-auto">
                ...
                <Button
                  ...
                  className="w-full justify-start gap-3 h-auto py-4 px-4"
                >
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-lime-500/10 text-lime-600 dark:text-lime-400">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-xs text-muted-foreground font-normal">
                      Show yesterday's missed tasks popup again
                    </div>
                  </div>
