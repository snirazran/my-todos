    ...
    <div className="w-full bg-card/40 backdrop-blur-xl border border-border/50 rounded-[24px] p-4 shadow-sm relative overflow-hidden group">
      ...
      {!isPremium && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/90 to-background transition-opacity duration-500" />
              ...
              <div className="p-8 pt-4">
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground text-sm font-medium leading-relaxed px-2">
                    Supercharge your productivity with advanced tools and
                  ...
                  {[
                    {
                      ...
                      sub: 'View patterns from day one',
                    },
                    {
                      text: 'Advanced Analytics',
                      sub: 'Deep dive into your habits',
                    },
                    {
                      text: 'Custom Widget Layouts',
                      sub: 'Personalize your dashboard',
                    },
                  ].map((feature, i) => (
                    <div
                      key={i}
      ...
      <div
        className={`space-y-6 transition-all duration-500 ${!isPremium ? 'opacity-10 pointer-events-none select-none' : ''}`}
      >
