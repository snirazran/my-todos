...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      'We share information with service providers that help operate Frogress, such as hosting, database, authentication, notification, analytics or diagnostics, email, app-store, and payment providers where applicable.',
